...
@DisplayName("Item Repository Integration Tests")
@Testcontainers
public class DefaultItemRepositoryIntegrationTest {

    private JdbcProperties jdbcProperties;

    private ItemRepositoryUseCases todoRepositoryUseCases;
    ...
    public void setUp() {
        ...
        this.todoRepositoryUseCases = new ItemRepositoryUseCases(new DefaultItemRepository(factory, defaultJdbcName));
    }

    @DisplayName("list item")
    @Test
    public void testListTodo() {
        todoRepositoryUseCases.testListItemTasks();
    }

    @DisplayName("add item")
    @Test
    public void testAddTodoTask() {
        todoRepositoryUseCases.verifyAddItemTask();
    }
